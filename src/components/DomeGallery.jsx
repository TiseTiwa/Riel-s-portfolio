...
import convo5 from "../assets/convo5.jpg";
import convo6 from "../assets/convo6.jpg";
import convo7 from "../assets/convo7.jpg";
...
import concert6 from "../assets/concert6.jpg";
...
export default function DomeGallery({
  ...
  return (
    <>
      ...
      <div
        ref={rootRef}
        className="sphere-root relative w-full h-full bg-gradient-to-b from-fuchsia-200 via-sky-100 to-emerald-100"
        style={{
          ["--segments-x"]: segments,
          ["--segments-y"]: segments,
